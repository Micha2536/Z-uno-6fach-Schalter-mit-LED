...
void loop() {
  ...
  if (val1 == LOW && state1 == 0 && currentValue1 == 0)
  {
    ...
    state1 = 1;
     ...
     if (val1 == LOW && state1 == 0 && currentValue1 == 255)
  {
    currentValue1 = 0;
...
if (val2 == HIGH){ 
  ...
  if (val2 == LOW && state2 == 0 && currentValue2 == 0)
  {
    ...
    state2 = 1;
     ...
     if (val2 == LOW && state2 == 0 && currentValue2 == 255)
  {
    currentValue2 = 0;
...
if (val3 == HIGH){ 
  ...
  if (val3 == LOW && state3 == 0 && currentValue3 == 0)
  {
    ...
    state3 = 1;
     ...
     if (val3 == LOW && state3 == 0 && currentValue3 == 255)
  {
    currentValue3 = 0;
 ...
 if (val4 == HIGH){ 
  ...
  if (val4 == LOW && state4 == 0 && currentValue4 == 0)
  {
    ...
    state4 = 1;
     ...
     if (val4 == LOW && state4 == 0 && currentValue4 == 255)
  {
    currentValue4 = 0;
...
if (val5 == HIGH){ 
  ...
  if (val5 == LOW && state5 == 0 && currentValue5 == 0)
  {
    ...
    state5 = 1;
     ...
     if (val5 == LOW && state5 == 0 && currentValue5 == 255)
  {
    currentValue5 = 0;
...
if (val6 == HIGH){ 
  ...
  if (val6 == LOW && state6 == 0 && currentValue6 == 0)
  {
    ...
    state6 = 1;
     ...
     if (val6 == LOW && state6 == 0 && currentValue6 == 255)
  {
    currentValue6 = 0;
